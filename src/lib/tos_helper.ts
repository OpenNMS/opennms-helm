 ...
 *
 * Select options are the codes themselves and ip precedence groups that cover these codes.
 *
 * Select options for codes that have a symbolic name are labelled by their symbolic name followed by their numeric
 * code. Codes that have no symbolic name are labelled by their numeric code only.
 *
